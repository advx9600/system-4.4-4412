...
BOARD_WPA_SUPPLICANT_DRIVER         := NL80211     #WEXT NL80211
...
RDA5876_BT_SUPPORT := rda587x

ifeq ($(strip $(RDA5876_BT_SUPPORT)), rda587x)
BOARD_HAVE_BLUETOOTH := true
BOARD_HAVE_BLUETOOTH_BCM := true
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/rpdzkj/$(TARGET_PRODUCT)/bluetooth
endif